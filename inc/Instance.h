...
class Instance {
 public:
  ...
  // enum valid_moves_t { NORTH, EAST, SOUTH, WEST, WAIT_MOVE, MOVE_COUNT };  // MOVE_COUNT is the
  // enum's size
 ...
 private:
  ...
  void generateConnectedRandomGrid(
      int rows, int cols, int obstacles);  // initialize new [rows x cols] map with random obstacles
